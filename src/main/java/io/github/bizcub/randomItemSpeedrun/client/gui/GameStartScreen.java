...
public class GameStartScreen extends Screen {
    ...
    protected void init() {
        ...
        //? >=1.20.2 {
        /*WidgetSprites sprites = new WidgetSprites(Utils.getResourceLocation("default"), Utils.getResourceLocation("disabled"), Utils.getResourceLocation("hovered"));
        ImageButton settingsButton = this.addRenderableWidget(new ImageButton(getWidthPercent(1), getHeightPercent(2.5), getWidthPercent(3.8), getWidthPercent(3.8), sprites, button -> this.minecraft.setScreen(ConfigHelper.getScreen(this))));
        *///?} else {
        var sprite = Utils.getResourceLocation("textures/gui/sprites/widgets.png");
        ImageButton settingsButton = this.addRenderableWidget(new ImageButton(getWidthPercent(1), getHeightPercent(2.5), getWidthPercent(3.8), getWidthPercent(3.8), 0, 0, getWidthPercent(3.9), sprite, getWidthPercent(12), getWidthPercent(12.1), button -> this.minecraft.setScreen(ConfigHelper.getScreen(this))));
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float a) {
        ...
        graphics.drawCenteredString(this.font, this.title, getWidthPercent(50), getHeightPercent(4), -1);
